...
Puede visualizar los esquemas completos como diagramas de flujo en [aquí](esquemas/Flujos_de_Mensajes_del_Sistema_Integrado) (se recomienda visualizar los archivos en formato .png).
